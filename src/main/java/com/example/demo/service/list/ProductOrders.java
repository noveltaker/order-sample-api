...
public final class ProductOrders extends AbstractOrders {

  ProductOrders(OrderRepository orderRepository, OrdersDTO dto) {
  ...
  public Page<OrderInfo> getList() {
    ...
    return getOrderRepository().findAllByProductId(pageRequest, dto.getSearchId(), OrderInfo.class);
  }
}
